...
# Also try to find 'models' directory explicitly
models_dir = os.path.join(current_dir, 'models')
if os.path.exists(models_dir) and current_dir not in sys.path:
     sys.path.append(current_dir)

# Debug print to verify paths in Zeabur logs
...
try:
    ...
    try:
        import groundwater_models
        import surfacewater_models
    except:
        st.error(f"Critical Error: Failed to import models. Path info: {sys.path}")
        raise e
import json
